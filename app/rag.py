...
2. ถ้าข้อมูลในเอกสารไม่เพียงพอที่จะตอบ ให้ตอบกลับเพียงประโยคเดียวว่า:
   "{not_found}"
3. ถ้ามีข้อมูล ให้สรุปคำตอบให้ชัดเจน และอ้างอิงชื่อไฟล์ต้นทางในวงเล็บท้ายประโยค เช่น (ที่มา: hr_policy.pdf)
"""
